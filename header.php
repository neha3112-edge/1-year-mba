<?php
$base_url = (strpos($_SERVER['REQUEST_URI'], '/assets/forms/') !== false) ? '../' : '';
?>
...
})(window,document,'script','dataLayer','GTM-567GP8S9');</script>
<!-- End Google Tag Manager -->



<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-17917271919"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-17917271919');
</script>